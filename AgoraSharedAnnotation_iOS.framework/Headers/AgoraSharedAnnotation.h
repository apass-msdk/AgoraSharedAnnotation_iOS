//
//  AgoraSharedAnnotation.h
//  AgoraSharedAnnotation_iOS
//
//  Created by yaodanliang on 2023/5/24.
//
...
@protocol AgoraSharedAnnotationDelegate <NSObject>
@optional
- (void)onInitializeCallback:(int)code message:(NSString *)message;
@end


@interface AgoraSharedAnnotation : NSObject
...
- (int)initWithUri:(NSString *)uri
          ...
          delegate:(id<AgoraSharedAnnotationDelegate>)delegate;
